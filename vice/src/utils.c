...
// Definitions for random normal generator
...
/*
 * returns a random number from a random normal distribution
 *
 * sourced from https://web.archive.org/web/20151030215612/http://home.online.no/~pjacklam/notes/invnorm/
 */
extern double randn() {
